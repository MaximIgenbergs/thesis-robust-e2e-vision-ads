...
from scripts.udacity.maps.configs.run import HOST, PORT
from scripts.udacity.maps.genroads.configs import paths, roads, run, scenarios
from scripts.udacity.logging.eval_runs import RunLogger, prepare_run_dir, module_public_dict, best_effort_git_sha, pip_freeze
...
def _build_adapter(model_name: str, image_size_hw, ckpt_path: Path | None):
    ...
    raise ValueError(f"Unknown MODEL_NAME '{model_name}' in scripts/udacity/configs/genroads/run.py")
