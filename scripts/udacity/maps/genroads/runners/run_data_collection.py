...
SIM and DATA_DIR are taken from scripts/udacity/maps/genroads/configs/paths.py
"""
...
from scripts.udacity.maps.genroads.configs import paths as gen_paths, roads
